package com.gmail.dimabah.javastart.homeworks.second;
...
public class DataTypes {
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("12-bit integer data type has a minimum value of " +
                (int) (-Math.pow(2, 12) / 2) + " and a maximum value of " +
                (int) (Math.pow(2, 12) / 2 - 1) + " (inclusive).");

        System.out.println();
        System.out.println("4-bit character data type can operate with " +
